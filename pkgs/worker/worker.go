...
func (w *Worker) Work(wg *sync.WaitGroup, newCustomerChan <-chan struct{}, closedChan <-chan struct{}, ordersChan chan customers.Customer, line *customers.CustomerQueue) {
    for {
        select {
